...
import { Search, Filter, Users, ChevronLeft, ChevronRight, Mail, Loader2 } from "lucide-react";
import { 
  Pagination, 
  PaginationContent, 
  PaginationEllipsis, 
  ...
  const fetchCandidates = async (page: number, append: boolean = false) => {
    try {
      ...
      try {
        ...
        console.error('Error fetching candidates from API, using mock data instead:', error);
        ...
        setPaginationInfo({
          ...
          totalPages: Math.ceil(filteredCandidates.length / mockPaginationInfo.limit)
        });
      }
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-24 pb-12">
        <div className="container mx-auto px-4">
                ...
                <Dialog open={emailDialogOpen} onOpenChange={setEmailDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[500px]">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Compose an email to send to {selectedCandidates.length} selected candidates.
                      </DialogDescription>
                    </DialogHeader>
          ...
          {/* View More Button */}
          {!loading && candidates.length > 0 && currentPage < paginationInfo.totalPages && (
            ...
            <div className="mt-10">
              <Pagination>
                <PaginationContent>
                  ...
                  {isMobile && (
                    <PaginationItem>
                      <span className="flex items-center gap-1">
                        <span className="text-sm font-medium">Page {currentPage} of {paginationInfo.totalPages}</span>
                      </span>
                    </PaginationItem>
                  )}
                  ...
                  <PaginationItem>
                    <PaginationNext 
                      onClick={() => currentPage < paginationInfo.totalPages && handlePageChange(currentPage + 1)}
