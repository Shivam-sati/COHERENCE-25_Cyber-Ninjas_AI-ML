...
import { UploadResumeBox } from "@/components/UploadResumeBox";
import { AnalyticsCard } from "@/components/AnalyticsCard";
import { CandidateCard } from "@/components/CandidateCard";
import { JobCard } from "@/components/JobCard";
import { BarChart4, BriefcaseIcon, FileSearch, Upload, Users } from "lucide-react";
                ...
                <Card className="card-glass border-0 shadow-lg">
                  <CardContent className="p-4">
                    <div className="space-y-4">
                      {[
                        { text: "New resume uploaded for UX Designer", time: "Just now" },
                        { text: "Taylor Lee matched 85% with Data Scientist role", time: "2 hours ago" },
                        { text: "Interview scheduled with Alex Johnson", time: "4 hours ago" },
                        { text: "New job posted: Marketing Manager", time: "Yesterday" },
                      ].map((activity, index) => (
                        <div key={index} className="flex justify-between items-start pb-3 border-b border-gray-100 dark:border-gray-800 last:border-0 last:pb-0">
